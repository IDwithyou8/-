...
B = [
                ...
                {
                    "display": "北京(大兴国际机场)",
                    "data": "Beijing(DAXING)|北京(大兴国际机场)(PKX)|1|BJS,PKX"
                },
                {
                    "display": "北京(首都国际机场)",
...
G = [
                ...
                {
                    "display": "中国高雄",
                    "data": "Kaohsiung|中国高雄(KHH)|720|KHH"
                },
                {
                    "display": "赣州",
...
H = [
                ...
                {
                    "display": "中国花莲",
                    "data": "Hualien|中国花莲(HUN)|6954|HUN"
                },
                {
                    "display": "霍林郭勒",
...
N = [
                ...
                {
                    "display": "中国南竿",
                    "data": "Nangan|中国南竿(LZN)|91804|LZN"
                },
                {
                    "display": "南充",
...
P = [
                {
                    "display": "中国澎湖列岛",
                    "data": "Penghu Islands|中国澎湖列岛(MZG)|5383|MZG"
                },
                {
                    "display": "攀枝花",
...
T = [
                ...
                {
                    "display": "中国台中",
                    "data": "Taichung|中国台中(RMQ)|3849|RMQ"
                },
                {
                    "display": "塔城",
                ...
                {
                    "display": "中国台南",
                    "data": "Tainan|中国台南(TNN)|3847|TNN"
                },
                {
                    "display": "中国台北",
                    "data": "Taipei|中国台北(TPE)|617|TPE"
                },
                {
                    "display": "天津",
                ...
                {
                    "display": "中国台东",
                    "data": "Taitung|中国台东(TTT)|3848|TTT"
                },
                {
                    "display": "唐山",
...
X = [
                ...
                {
                    "display": "中国香港",
                    "data": "Hong Kong|中国香港(HKG)|58|HKG"
                },
                {
                    "display": "西双版纳",
...
DATA = [A,B,C,D,E,F,G,H,J,K,L,M,N,P,Q,R,S,T,W,X,Y,Z]
dic = []
dicnew = []
for i in DATA:
    for data in i:
...
for data in dic:
    ...
    for key,value in data.items():
        itemsnew = {key:re.sub(r'\D', "", value)}
        dicnew.append(itemsnew)
    # print(key,itemsnew[value])
